        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Ángulo: {sector.angle}°</p>
            </div>
          </div>
          <span className={`px-2 py-1 text-xs font-medium rounded-full ${statusColors[sector.status]}`}>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-sm">
              ...
              <p className="font-medium">#{sector.position}</p>
            </div>
            <div className="text-sm">
              <p className="text-gray-600">Material</p>
              <p className="font-medium">{sector.material}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-sm">
              ...
              <p className="font-medium">{sector.area} m²</p>
            </div>
            <div className="text-sm">
              <p className="text-gray-600">Costo</p>
              <p className="font-medium">${sector.cost.toFixed(2)}</p>
            </div>
          </div>
